...
public class Exercise9 {
    ...
    public void testLongRedirect() {
        String[] passwd = {"password", 	"password", 	"123456", 	"123456", 	"123456", 	"123456", 	"123456", 	"123456", 	"123456",
        ...
        for(int i = 0; i < passwd.length; i++){
            ...
            Response responseForCheck = RestAssured
                    ...
                    .andReturn();
            String authorized = responseForCheck.print();

            if (authorized.equals("You are authorized")){
                System.out.println("Your password: " + passwd[i]);
                break;
            }
            else i++;
        }
